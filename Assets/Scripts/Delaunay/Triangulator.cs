...
namespace Delaunay
{
    class Triangulator
    {
        ...
        private void Analyse(List<Vector2> suppliedPoints, Hull hull, List<Triad> triads, bool rejectDuplicatePoints, bool hullOnly)
        {
            ...
            {
                distance2ToCentre[k] = Vector2.Distance(points[0], points[k]);
                sortedIndices[k] = k;
            }
            ...
            for (int k = 3; k < nump; k++)
                distance2ToCentre[k] = Vector2.Distance(points[sortedIndices[k]], centre);
        ...
        public List<Triad> Triangulation(List<Vector2> points, bool rejectDuplicatePoints)
        {
            ...
            // and the generationAlgorithm failing to stop.
